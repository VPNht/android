    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        public void startVPN(String name, String inlineConfig) throws RemoteException {
            ...
            try {
                ...
                vp.mUsername = PrefUtils.get(ExternalOpenVPNService.this, Preferences.USERNAME, "");
                vp.mPassword = PrefUtils.get(ExternalOpenVPNService.this, Preferences.PASSWORD, "");
